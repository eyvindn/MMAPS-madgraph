...
C     ----------
      ...
      CALL VXXXXX(P(0,4),MDL_MDP,NHEL(4),+1*IC(4),W(1,4))
      CALL FFV1_1(W(1,1),W(1,3),GC_1,MDL_ME,ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,2),W(1,5),W(1,4),GC_3,AMP(1))
      CALL FFV1_1(W(1,1),W(1,4),GC_3,MDL_ME,ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,2),W(1,5),W(1,3),GC_1,AMP(2))
      JAMP(1)=-AMP(1)-AMP(2)
      MATRIX1 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
