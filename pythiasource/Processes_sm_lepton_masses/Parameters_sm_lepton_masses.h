...
#ifndef Pythia8_parameters_sm_lepton_masses_H
#define Pythia8_parameters_sm_lepton_masses_H
...
class Parameters_sm_lepton_masses
{
  public:
    ...
    static Parameters_sm_lepton_masses * getInstance(); 

    // Model parameters independent of aS
    double mdl_WTau, mdl_WH, mdl_WT, mdl_WW, mdl_WZ, mdl_MTA, mdl_MM, mdl_Me,
        mdl_MH, mdl_MB, mdl_MT, mdl_MZ, mdl_ymtau, mdl_ymm, mdl_yme, mdl_ymt,
        mdl_ymb, mdl_Gf, aEWM1, mdl_conjg__CKM3x3, mdl_CKM3x3,
        mdl_conjg__CKM1x1, ZERO, mdl_MZ__exp__2, mdl_MZ__exp__4, mdl_sqrt__2,
    ...
    std::complex<double> GC_1, GC_2, GC_3, GC_4, GC_5, GC_6, GC_7, GC_8, GC_9,
        ...
        GC_77, GC_78, GC_79, GC_80, GC_81, GC_82, GC_83, GC_86, GC_87, GC_88,
        GC_89, GC_90, GC_91, GC_92, GC_93, GC_94, GC_95, GC_96, GC_97, GC_98,
        GC_99, GC_100;
  ...
  private:
    static Parameters_sm_lepton_masses * instance; 
}; 

}  // end namespace Pythia8
#endif  // Pythia8_parameters_sm_lepton_masses_H
