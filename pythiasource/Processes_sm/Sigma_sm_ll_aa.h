...
#ifndef Pythia8_Sigma_sm_ll_aa_H
#define Pythia8_Sigma_sm_ll_aa_H
...
class Sigma_sm_ll_aa : public Sigma2Process 
{
  public:
    ...
    virtual string name() const {return "ll_aa (sm)";}
...
#endif  // Pythia8_Sigma_sm_ll_aa_H
