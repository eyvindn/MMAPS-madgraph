{
//=========Macro generated from canvas: tempo36/
//=========  (Tue Sep 30 16:04:18 2014) by ROOT version5.34/09
   TCanvas *tempo36 = new TCanvas("tempo36", "",0,0,700,500);
   gStyle->SetOptStat(0);
   tempo36->SetHighLightColor(2);
   tempo36->Range(-0.01612903,-7.235049e+10,0.1129032,5.305703e+11);
   tempo36->SetFillColor(0);
   tempo36->SetBorderMode(0);
   tempo36->SetBorderSize(3);
   tempo36->SetLeftMargin(0.125);
   tempo36->SetBottomMargin(0.12);
   tempo36->SetFrameBorderMode(0);
   tempo36->SetFrameBorderSize(0);
   tempo36->SetFrameBorderMode(0);
   tempo36->SetFrameBorderSize(0);
   ...
   TH1F *mystack_stack_36 = new TH1F("mystack_stack_36","",50,0,0.1);
   mystack_stack_36->SetMinimum(0);
   mystack_stack_36->SetMaximum(4.702782e+11);
   mystack_stack_36->SetDirectory(0);
   mystack_stack_36->SetStats(0);

   Int_t ci;   // for color index setting
   ci = TColor::GetColor("#000099");
   mystack_stack_36->SetLineColor(ci);
   mystack_stack_36->SetLineWidth(2);
   mystack_stack_36->GetXaxis()->SetTitle("p_{T} [ a ] (GeV/c) ");
   mystack_stack_36->GetXaxis()->SetLabelFont(22);
   mystack_stack_36->GetXaxis()->SetTitleSize(0.06);
   mystack_stack_36->GetXaxis()->SetTitleOffset(0.85);
   mystack_stack_36->GetXaxis()->SetTitleFont(22);
   mystack_stack_36->GetYaxis()->SetTitle("N. of a ( L_{int} = 10 fb^{-1} )");
   mystack_stack_36->GetYaxis()->SetLabelFont(22);
   mystack_stack_36->GetYaxis()->SetTitleSize(0.06);
   mystack_stack_36->GetYaxis()->SetTitleOffset(0.98);
   mystack_stack_36->GetYaxis()->SetTitleFont(22);
   mystack_stack_36->GetZaxis()->SetLabelFont(42);
   mystack_stack_36->GetZaxis()->SetLabelSize(0.035);
   mystack_stack_36->GetZaxis()->SetTitleSize(0.035);
   mystack_stack_36->GetZaxis()->SetTitleFont(42);
   mystack->SetHistogram(mystack_stack_36);
