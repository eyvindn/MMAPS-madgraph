{
//=========Macro generated from canvas: tempo41/
//=========  (Tue Sep 30 16:04:18 2014) by ROOT version5.34/09
   TCanvas *tempo41 = new TCanvas("tempo41", "",0,0,700,500);
   gStyle->SetOptStat(0);
   tempo41->SetHighLightColor(2);
   tempo41->Range(-0.01612903,-7.235049e+10,0.1129032,5.305703e+11);
   tempo41->SetFillColor(0);
   tempo41->SetBorderMode(0);
   tempo41->SetBorderSize(3);
   tempo41->SetLeftMargin(0.125);
   tempo41->SetBottomMargin(0.12);
   tempo41->SetFrameBorderMode(0);
   tempo41->SetFrameBorderSize(0);
   tempo41->SetFrameBorderMode(0);
   tempo41->SetFrameBorderSize(0);
   ...
   TH1F *mystack_stack_41 = new TH1F("mystack_stack_41","",50,0,0.1);
   mystack_stack_41->SetMinimum(0);
   mystack_stack_41->SetMaximum(4.702782e+11);
   mystack_stack_41->SetDirectory(0);
   mystack_stack_41->SetStats(0);

   Int_t ci;   // for color index setting
   ci = TColor::GetColor("#000099");
   mystack_stack_41->SetLineColor(ci);
   mystack_stack_41->SetLineWidth(2);
   mystack_stack_41->GetXaxis()->SetTitle("p_{T} [ a ] (GeV/c) ");
   mystack_stack_41->GetXaxis()->SetLabelFont(22);
   mystack_stack_41->GetXaxis()->SetTitleSize(0.06);
   mystack_stack_41->GetXaxis()->SetTitleOffset(0.85);
   mystack_stack_41->GetXaxis()->SetTitleFont(22);
   mystack_stack_41->GetYaxis()->SetTitle("N. of a ( L_{int} = 10 fb^{-1} )");
   mystack_stack_41->GetYaxis()->SetLabelFont(22);
   mystack_stack_41->GetYaxis()->SetTitleSize(0.06);
   mystack_stack_41->GetYaxis()->SetTitleOffset(0.98);
   mystack_stack_41->GetYaxis()->SetTitleFont(22);
   mystack_stack_41->GetZaxis()->SetLabelFont(42);
   mystack_stack_41->GetZaxis()->SetLabelSize(0.035);
   mystack_stack_41->GetZaxis()->SetTitleSize(0.035);
   mystack_stack_41->GetZaxis()->SetTitleFont(42);
   mystack->SetHistogram(mystack_stack_41);
