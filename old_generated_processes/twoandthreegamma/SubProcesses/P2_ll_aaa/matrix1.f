...
C     
C     Process: e+ e- > a a a QED=99 QCD=99 @2
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV1_1(W(1,1),W(1,3),GC_3,ZERO,ZERO,W(1,6))
      CALL FFV1_2(W(1,2),W(1,4),GC_3,ZERO,ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_1(W(1,1),W(1,4),GC_3,ZERO,ZERO,W(1,6))
      CALL FFV1_2(W(1,2),W(1,3),GC_3,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,9),W(1,6),W(1,5),GC_3,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,8),W(1,6),W(1,3),GC_3,AMP(4))
      CALL FFV1_1(W(1,1),W(1,5),GC_3,ZERO,ZERO,W(1,6))
