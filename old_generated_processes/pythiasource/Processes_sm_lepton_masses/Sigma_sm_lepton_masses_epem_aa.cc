...
#include "Sigma_sm_lepton_masses_epem_aa.h"
#include "HelAmps_sm_lepton_masses.h"

using namespace Pythia8_sm_lepton_masses; 
...
void Sigma_sm_lepton_masses_epem_aa::initProc() 
{
  // Instantiate the model class and set parameters that stay fixed during run
  pars = Parameters_sm_lepton_masses::getInstance(); 
...
void Sigma_sm_lepton_masses_epem_aa::sigmaKin() 
{
...
double Sigma_sm_lepton_masses_epem_aa::sigmaHat() 
{
...
void Sigma_sm_lepton_masses_epem_aa::setIdColAcol() 
{
  if(id1 == -11 && id2 == 11)
  {
...
double Sigma_sm_lepton_masses_epem_aa::weightDecay(Event& process, int iResBeg,
    int iResEnd)
{
...
void Sigma_sm_lepton_masses_epem_aa::calculate_wavefunctions(const int perm[],
    const int hel[])
{
  ...
  FFV1_1(w[0], w[2], pars->GC_3, pars->mdl_Me, pars->ZERO, w[4]); 
  FFV1_1(w[0], w[3], pars->GC_3, pars->mdl_Me, pars->ZERO, w[5]); 
...
double Sigma_sm_lepton_masses_epem_aa::matrix_1_epem_aa() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 2; 
