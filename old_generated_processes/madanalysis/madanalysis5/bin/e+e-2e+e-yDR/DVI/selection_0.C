...
//=========  (Mon Oct 20 12:35:39 2014) by ROOT version5.34/09
   TCanvas *tempo3 = new TCanvas("tempo3", "",0,0,700,500);
   gStyle->SetOptStat(0);
   tempo3->SetHighLightColor(2);
   tempo3->Range(-0.0008064516,-0.1538462,0.005645161,1.128205);
   ...
   TH1F *mystack_stack_3 = new TH1F("mystack_stack_3","",100,0,0.005);
