                      ...
                      const std::map<std::string,std::string>& parameters)
{
  ...
  H0_ = plots_.Add_Histo("selection_0",100,0.0,0.05);
  H1_ = plots_.Add_Histo("selection_1",100,0.0,0.05);
  H2_ = plots_.Add_Histo("selection_2",100,0.0,0.05);
...
bool user::Execute(SampleFormat& sample, const EventFormat& event)
{
  ...
  H0_->IncrementNEvents(__event_weight__);
  {
    ...
    {
      H0_->Fill(_P_aPTorderingfinalstate[ind[0]]->pt(),__event_weight__);
    }
  }
  }
  ...
  {
    UInt_t ind[1];
    for (ind[0]=0;ind[0]<_P_e_pPTorderingfinalstate.size();ind[0]++)
    {
      H1_->Fill(_P_e_pPTorderingfinalstate[ind[0]]->pt(),__event_weight__);
    }
  }
  }
  ...
  {
    UInt_t ind[1];
    for (ind[0]=0;ind[0]<_P_e_mPTorderingfinalstate.size();ind[0]++)
    {
      H2_->Fill(_P_e_mPTorderingfinalstate[ind[0]]->pt(),__event_weight__);
    }
  }
  }
